...
public class DummyShipOpponent extends Ship {
	
	public DummyShipOpponent(boolean isPlayer, Vector2<Double> position) {
		// Creates the ship
...
//		Weapon w = new DummyGun();
		...
		Weapon w2 = new ArmeIonique(weaponControl.getCurrentLevel());
...
//		motor.setWeapon(w3);
		...
		addCrewMember(new CrewMember("Leonardo"));
	}
